...
type ComponentProps<T = {}> = React.HTMLAttributes<T> & { className?: string };
...
const components = {
  ...
  pre: ({
    ...
    __rawString__,
    ...props
  }: ComponentProps<HTMLPreElement> & { __rawString__?: string }) => (
  ...
  Callout,
  Card: MdxCard,
  Step: ({ className, ...props }: ComponentProps<HTMLHeadingElement>) => (
    <h3
      className={cn(
  ...
  Steps: ({ ...props }: ComponentProps<HTMLDivElement>) => (
    <div
